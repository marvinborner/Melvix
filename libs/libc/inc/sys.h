...
#define DISK_RAW 0xffffffff

NONNULL err disk_read(u32 id, u32 part, void *buf, u32 offset, u32 count);
NONNULL err disk_write(u32 id, u32 part, const void *buf, u32 offset, u32 count);
